...
<div class="col-md-3 mb-4">
    <div class="card h-100">
        <img src="{{ asset('images/' . $comic->url_imagen) }}" class="card-img-top" alt="{{ $comic->nombre }}">
        ...
        <div class="card-body d-flex flex-column">
            ...
            <div class="mt-auto">
                <h6 class="mb-3 fw-bold">Precio: ${{ number_format($comic->precio, 2) }}</h6>
                
                {{-- LÓGICA DE USER CLIENTE --}}
